...
const Education = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-[#FCFAFA]">
      <h3 className="w-full mb-[0.5rem] text-xl sm:text-xl md:text-2xl xl:text-[3rem] font-semibold py-5 xl:py-10 text-black text-center ">Edu<span className='text-yellow-500'>cation</span></h3>
